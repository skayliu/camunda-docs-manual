...
title: "Update a JBoss/Wildfly Installation from 7.16 to 7.17"
...
7 and Wildfly server in a shared process engine scenario. Throughout the procedure, refer to the [update guide][update-guide]. If not
already done, download the [Camunda Platform 7.17 JBoss distribution](https://downloads.camunda.cloud/release/camunda-bpm/jboss/7.17/)
